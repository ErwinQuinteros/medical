    ...
    return (
        <div>
            <div className="max-w-[1224px] mx-auto">
                <div className="grid items-center w-full gap-8 px-6 py-10 lg:grid-cols-2 lg:gap-12 lg:py-28">
                    <div className="text-center lg:text-left">
                        ...
                        <div className="flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
                            ...
                            <a
                                href="#"
                                className="bg-[#2490EB] text-white hover:bg-[#1e77c4] px-7 py-4 text-sm font-semibold rounded-full transition duration-300 uppercase text-center"
                            >
                                Agendar Examen
                            </a>
                        </div>
